...
\e[92m               `-..-`    \e[93m└─┘└─┘└─┘ \e[92m└─┘'
echo
echo -e '            \e[92m::: Tool By Team prox-t :::\e[0m'
echo -e '          \e[92m::: https://github.com/omarproxt :::\e[0m'
echo -e "\e[92m"
echo -e '                \e[100m omar prox t\e[0m'
echo
}
menu() {
...
then
xdg-open https://t.me/omarproxt25 2>/dev/null
elif [[ "$sit" = "5" || "$sit" = "five" ]];
then
xdg-open https://github.com/omarproxt 2>/dev/null
elif [[ "$sit" = "6" || "$sit" = "six" ]];
then
xdg-open https://www.youtube.com/@omarproxt > /dev/null 2>&1
elif [[ "$sit" = "7" || "$sit" = "seven" ]];
then
xdg-open https://github.com/omarproxt > /dev/null 2>&1
...
echo -e '\e[92m   THANKS FOR READING SUBSCRIBE {Team prox-t}'
